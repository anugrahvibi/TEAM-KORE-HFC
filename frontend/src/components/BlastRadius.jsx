                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div>
                                ...
                                <h3 className="text-4xl md:text-5xl font-black text-white tracking-tight">
                                    72% <span className="text-2xl md:text-3xl font-normal text-red-200/60">Rollback Probability</span>
                                </h3>
                                <p className="mt-2 text-red-200 max-w-xl">
                                    This change introduces a latency regression in the critical path that exceeds SLA checks.
                                </p>
                            </div>
                        ...
                        <Card title="Monthly Cost Forecast" className="h-full">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center p-3 rounded-lg hover:bg-slate-700/30 transition-colors">
                                    ...
                                    <span className="font-mono text-slate-400">+$120.00</span>
                                </div>
                                ...
                                <div className="flex justify-between items-center p-3 rounded-lg bg-orange-500/10 border border-orange-500/20">
                                    ...
                                    <span className="font-mono font-bold text-orange-400">+$322.00</span>
                                </div>
