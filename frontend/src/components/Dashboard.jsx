            ...
            <Card title="Microservice Health" className="h-full">
                <div className="space-y-4">
                    ...
                    <div className="mt-8 pt-4 border-t border-slate-700/50">
                        {!isDisasterMode ? (
                            <button
                                className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-semibold transition-colors duration-200 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {activeDeploy ? (
                                    <>
                            ...
                            <button
                                ...
                                className="w-full py-3 px-4 bg-slate-700 hover:bg-slate-600 text-slate-200 rounded-lg font-semibold transition-colors duration-200 border border-slate-600 hover:border-slate-500 flex items-center justify-center gap-2"
                            >
                                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
